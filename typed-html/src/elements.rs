...
declare_elements! {
    ...
    path { // TODO: support all SVG presentation attributes
        ...
        stroke-linecap: String, // TODO: too permissive and should be generalized to other elements as well
        stroke-width: String, // TODO: too permissive and should be generalized to other elements as well
        stroke-linejoin: String, // TODO: too permissive and should be generalized to other elements as well
    } in [SvgContent];
    ...
    svg {
        ...
        fill: String, // TODO: too permissive and should be generalized to other elements as well
        stroke: String, // TODO: too permissive and should be generalized to other elements as well
...
fn test_svg_element_2() {
    ...
    assert_eq!(
        r#"<svg class="h-6 hidden w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M6 18L18 6M6 6l12 12" stroke_linecap="round" stroke_linejoin="round" stroke_width="2"></path></svg>"#,
        elem.to_string()
    );
}
